...
class WhitelabelSetting(Document):
	def validate(self):
		...
		if frappe.db.exists("DocType","Navbar Settings") and self.application_logo:
			frappe.db.set_value("Navbar Settings","Navbar Settings","app_logo","/assets/whitelabel/images/Untitled-1.png")
			frappe.db.set_value("Website Settings","Website Settings","app_logo","/assets/whitelabel/images/Untitled-1.png")
			self.app_logo_set = 1
